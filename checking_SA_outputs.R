...
for(k in 1:(length(D)-1)){
  ...
  #print(paste0("tot_size[length(T_KrigingSobol)]: ",tot_size[length(T_KrigingSobol)]))
  #print(paste0("Sobol_Kriging_convergesize: ",Sobol_Kriging_convergesize))
...
for(k in 1:length(D)){
  ...
  print(paste0("length(T_BASS): ",length(T_BASS)))
  print(paste0("length(BASS_size_vec): ",length(BASS_size_vec)))
}
...
for(k in 1:(length(D)-1)){
  ...
  print(paste0("Sobol_AKMCS_convergesize: ",Sobol_AKMCS_convergesize))
