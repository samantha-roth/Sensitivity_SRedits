...
Time_Sobol_arr<- array(0, dim = c(length(tested_D), length(tested_eval_time), n_nodes+1))

load(paste0("./Ranking_Data/Time_Sobol_node0"))
Time_Sobol_arr[,,1]<- Time_Sobol

Time_BASS_arr<- array(0, dim = c(length(tested_D), length(tested_eval_time), n_nodes+1))

load(paste0("./Ranking_Data/Time_BASS_node0"))
Time_BASS_arr[,,1]<- Time_BASS

Time_Kriging_arr<- array(0, dim = c(length(tested_D), length(tested_eval_time), n_nodes+1))
load(paste0("./Ranking_Data/Time_Kriging_node0"))
Time_Kriging_arr[,,1]<- Time_Kriging

Time_AKMCS_arr<- array(0, dim = c(length(tested_D), length(tested_eval_time), n_nodes+1))
