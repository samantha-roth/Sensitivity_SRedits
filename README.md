...
3. Scripts starting with 5_ compute quantities to compare the sensitivity analysis approaches based on their outputs.
    ...
    * After running all of those, you can run `5_getMeanBestAllModels.R`, `5_getMeanWorstAllModels.R`, `getBiggestRangeAllSeedsAllModels.R`, and `getSmallestRangeAllSeedsAllModels.R`.
