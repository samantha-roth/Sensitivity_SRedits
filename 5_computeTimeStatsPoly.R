...
load(paste0("./Ranking_Data/Polynomial/Time_Sobol_node0"))
Time_Sobol_arr[,,1]<- Time_Sobol

Time_BASS_arr<- array(0, dim = c(length(tested_D), length(tested_eval_time), n_nodes))

load(paste0("./Ranking_Data/Polynomial/Time_BASS_node0"))
Time_BASS_arr[,,1]<- Time_BASS

Time_Kriging_arr<- array(0, dim = c(length(tested_D), length(tested_eval_time), n_nodes))
load(paste0("./Ranking_Data/Polynomial/Time_Kriging_node0"))
Time_Kriging_arr[,,1]<- Time_Kriging

Time_AKMCS_arr<- array(0, dim = c(length(tested_D), length(tested_eval_time), n_nodes))
load(paste0("./Ranking_Data/Polynomial/Time_AKMCS_node0"))
Time_AKMCS_arr[,,1]<- Time_AKMCS

for(node in 2:n_nodes){
  
  load(paste0("./Ranking_Data/Polynomial/Time_Sobol_node",node-1))
  Time_Sobol_arr[,,node]<- Time_Sobol
  
  load(paste0("./Ranking_Data/Polynomial/Time_BASS_node",node-1))
  Time_BASS_arr[,,node]<- Time_BASS
  
  load(paste0("./Ranking_Data/Polynomial/Time_Kriging_node",node-1))
  Time_Kriging_arr[,,node]<- Time_Kriging
  
  load(paste0("./Ranking_Data/Polynomial/Time_AKMCS_node",node-1))
  Time_AKMCS_arr[,,node]<- Time_AKMCS
}

save(Time_Sobol_arr,file=paste0("./Ranking_Data/Polynomial/Time_Sobol_arr"))
save(Time_BASS_arr,file=paste0("./Ranking_Data/Polynomial/Time_BASS_arr"))
save(Time_Kriging_arr,file=paste0("./Ranking_Data/Polynomial/Time_Kriging_arr"))
save(Time_AKMCS_arr,file=paste0("./Ranking_Data/Polynomial/Time_AKMCS_arr"))
...
vals <- Mean_Time_Kriging[i,j]
if (all(is.na(vals))) {
  warning(paste("All values are NA for Kriging at D =", tested_D[i], ", time =", tested_eval_time[j]))
}

save(Mean_Time_Sobol,Min_Time_Sobol,Max_Time_Sobol,Var_Time_Sobol,
     file=paste0("./Ranking_Data/Polynomial/Summary_Time_Sobol"))

save(Mean_Time_BASS,Min_Time_BASS,Max_Time_BASS,Var_Time_BASS,
     file=paste0("./Ranking_Data/Polynomial/Summary_Time_BASS"))

save(Mean_Time_Kriging,Min_Time_Kriging,Max_Time_Kriging,Var_Time_Kriging,
     file=paste0("./Ranking_Data/Polynomial/Summary_Time_Kriging"))

save(Mean_Time_AKMCS,Min_Time_AKMCS,Max_Time_AKMCS,Var_Time_AKMCS,
     file=paste0("./Ranking_Data/Polynomial/Summary_Time_AKMCS"))
