...
print("4_AKMCSSACSMA10_diffseeds.R")
...
foreach(node = 1:4)%dopar%{ 
  ...
  folder <- paste0(folderpath,"SacSma10/AKMCS/seed",seed) 
  ...
  X_SACSMA<- cbind(X_SACSMA[,1:2],fix_vals[1],X_SACSMA[,3:5],fix_vals[2],X_SACSMA[,6:9],
                   fix_vals[3],X_SACSMA[,10],known_pars[1],known_pars[2],known_pars[3])
