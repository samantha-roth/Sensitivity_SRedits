...
for (i in 1:(length(D))) {
  folder <- paste0("./polynomial/Ranking_Data/",tested_D[i])
...
save(Time_Sobol,file=paste0("./polynomial/Ranking_Data/Time_Sobol_node0"))
...
save(Time_BASS,file=paste0("./polynomial/Ranking_Data/Time_BASS_node0"))
save(Time_Kriging,file=paste0("./polynomial/Ranking_Data/Time_Kriging_node0"))
save(Time_AKMCS,file=paste0("./polynomial/Ranking_Data/Time_AKMCS_node0"))
################################################################################
#other nodes
...
for(node in 1:(n_nodes-1)){
  ...
  save(Time_Sobol,file=paste0("./polynomial/Ranking_Data/Time_Sobol_node",node))
}
...
for(node in 1:(n_nodes-1)){
  ...
  save(Time_BASS,file=paste0("./polynomial/Ranking_Data/Time_BASS_node",node))
  save(Time_Kriging,file=paste0("./polynomial/Ranking_Data/Time_Kriging_node",node))
  save(Time_AKMCS,file=paste0("./polynomial/Ranking_Data/Time_AKMCS_node",node))
}